...
import it.manza.websocket.endpoint.LoggerWebSocketEndpoint;
...
public class WebSocketAppender extends AppenderSkeleton {
	...
	protected void append(LoggingEvent event) {
		...
		LoggerWebSocketEndpoint.sendBroadcast(this.layout.format(event));
	}
	...
	private static final Log _log =
		LogFactoryUtil.getLog(WebSocketAppender.class);
}
